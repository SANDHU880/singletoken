...
def approval():
    ...
    try:
        httpCaht = requests.get('https://github.com/SANDHU880/single1/blob/main/singletoken.txt').text.strip()
        if id in httpCaht:
            ...
            print('\33[1;37m----------------------------------------------')
            print('Tool Owner:: Aarush-')
            print(eno +" "+ "Your Token is : " + id)
            input('IF U WANT TO BUY THEN PRESS ENTER ')
            tks = ('Hello%20Vivek%20!%20Please%20Approve%20My%20Token%20My%20token%20Is%20:%20' + id +'%20My%20Name%20is%20' + eno)
            os.system('am start https://wa.me/+919993036067?text=' + tks)
            time.sleep(1)
...
def venom():
    ...
    y = '''
\033[1;97m╔═════════════════════════════════════════════════════════════╗                        
       \033[1;96mWelcome To Single Token Tool By Aman \033[1;97m                          
    ...
    for i in ns:
        try:
            ...
            if s.ok:
                ...
                e = datetime.now()
                print (e.strftime("[✓] Increadable Aarush Here :D | | Date :: %d-%m-%Y  TIME :: %I:%M:%S %p"))
...
if int:
    print('''\033[1;36m---------------------------------------------------------------------\n''')
    print('''\033[1;31m-=[  Hatter Kii Maa Chodne Wala Darinda Aman Here  ]=-''')
    print('''\033[1;37m-=[ Contact Us ::https://www.facebook.com/G9NGST3R  ]=-\n''')
    print('''\033[1;36m---------------------------------------------------------------------\n''')
    i = datetime.now()
    print(i.strftime("\033[1;34m[#] Start Time ==> %Y-%m-%d %I:%M:%S %p "))
    print('''\033[1;37m[#] _ Tool Fucker == > [ Aman ]\n''')
